...
(defun laptop-font()
  ...
  (set-face-attribute 'mode-line          nil :family pmc/modeline-font :height 120 :weight 'bold)
...
(defun desktop-font ()
  ...
  (set-face-attribute 'mode-line          nil :family 'pmc/modeline-font :height 80  :weight 'bold)
  (set-face-attribute 'mode-line-inactive nil :family 'pmc/modeline-font :height 80  :weight 'normal)
  (set-face-attribute 'minibuffer-prompt  nil :family 'pmc/modeline-font :height 80  :weight 'bold))
